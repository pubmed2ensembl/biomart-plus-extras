...
BioMart::Formatter::TSV_36

=head1 SYNOPSIS

The TSV_36 Formatter returns tab separated tabular data
for a BioMart query's ResultTable

=head1 DESCRIPTION

When given a BioMart::ResultTable containing the results of 
a BioMart::Query the TSV_36 Formatter will return tabular output
...
package BioMart::Formatter::TSV_36;
